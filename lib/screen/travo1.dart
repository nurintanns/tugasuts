...
class Travo1 extends StatefulWidget {
  @override
  _Travo1State createState() => new _Travo1State();
}

class _Travo1State extends State<Travo1> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      iconTheme: IconThemeData(color: Colors.black),
        title: Text('Travo 1', style: TextStyle(color: Colors.blue)), 
        ),
        body: ListView(
          children: <Widget>[
            _top(),
